...
# 👇 Add this at the top of your file or inside `if __name__ == '__main__':`
def start_react():
    try:
        subprocess.Popen(["npm", "run", "dev"], cwd="./shopping_app")  # change to your React app path
        time.sleep(3)  # give it time to boot
        webbrowser.open("http://localhost:5173")  # open in browser
